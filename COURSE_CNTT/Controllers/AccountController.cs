...
namespace COURSE_CNTT.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    if(GetIdUserByName(model.Email))
                    {
                    ...
                    else
                    {
                        ...
                        Session["MaGH"] = null;
                        ModelState.AddModelError("", "Tài khoản của bạn đã bị khóa do vi phạm điều khoản !!!");
                        return View(model);
                    }
        ...
        public bool GetIdUserByName(string name)
        {
        ...
        {
            ViewBag.MaHP = new SelectList(db.HOCPHANs, "KhoaHoc", "KhoaHoc");
            return View();
        }
